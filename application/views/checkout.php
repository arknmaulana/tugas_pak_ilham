        ...
        <div id="content" class="float_r">
          ...
          PHONE<br />
            ...
            <table style="border:1px solid #CCCCCC;" width="100%">
                <tr>
                    <td height="80px"> <img src="<?= base_url('assets/assets2/') ?>images/paypal.gif" alt="paypal" /></td>
                ...
                <tr>
                    <td  height="80px"><img src="<?= base_url('assets/assets2/') ?>images/2co.gif" alt="paypal" />
                    </td>
